...
router.get("/me", auth, async (req, res) => {
  try {
    ...
    if (!profile) {
      return res
        .status(400)
        .json({ msg: "There isnt a profile for this user!" });
    }
  } catch (err) {
...
// @desc Gets all the profiles available
// @access Public
...
// @desc Gets profile by the user's id
// @access Public
...
// @desc Delete profile along with users and posts
// @access Private
router.delete("/", auth, async (req, res) => {
  try {
    //Remove profile with posts
...
// @desc Removes user's experience
// @access Private
